...
import { LayoutDashboard, Users, Building2, Clock, CalendarCheck, LogOut, Briefcase } from 'lucide-react'
...
const nav = [
  ...
  { to: '/hr/leaves', icon: CalendarCheck, label: 'Leaves' },
]
      ...
      <aside className="fixed inset-y-0 left-0 w-60 bg-slate-900 flex flex-col z-20">
        ...
        <div className="flex items-center gap-3 px-5 py-5 border-b border-slate-800">
          ...
          <div>
            ...
            <p className="text-slate-400 text-xs truncate max-w-[120px]">{user?.tenantId}</p>
          </div>
        </div>
        ...
        <div className="px-3 py-4 border-t border-slate-800">
          <div className="px-3 py-2 mb-2">
            ...
            <span className="inline-block mt-1 px-2 py-0.5 bg-blue-600/20 text-blue-400 text-xs rounded-full">HR Manager</span>
          </div>
          <button
